...
public class InRangeNeuralNetwork {
   ...
   Note #1
    ...
    public static void main(String[] args) {
        InRangeNeuralNetwork exampleChart = new InRangeNeuralNetwork("D:/sampledata/normalized_train.csv", 1, 1);
        exampleChart.saveNetworkOutput("D:/sampledata/network_output.csv");
